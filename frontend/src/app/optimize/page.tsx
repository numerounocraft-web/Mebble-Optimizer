  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ ...(isMobile ? {} : { flex: 1, overflowY: "auto" }), padding: "24px", display: "flex", flexDirection: "column", gap: "20px" }}>

          {/* File upload */}
          <div>
            <p style={{ fontSize: "15px", fontWeight: 600, color: "#020202", letterSpacing: "-0.01em", marginBottom: "10px" }}>
              Resume PDF
            </p>
            <div
            ...
            >
              ...
              {file ? (
                ...
                <>
                  ...
                  <span style={{ fontSize: "15px", fontWeight: 500, color: "#767678", letterSpacing: "-0.01em" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            <p style={{ fontSize: "15px", fontWeight: 600, color: "#020202", letterSpacing: "-0.01em", margin: 0 }}>
              Job Description
            </p>
            <textarea
          ...
          {error && (
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              <span style={{ fontSize: "15px", color: "#F70407", fontWeight: 500 }}>{error}</span>
            </div>
          )}
      ...
      <div ref={resultsRef} style={{ flex: 1, backgroundColor: "#F9F9FB", overflowY: isMobile ? "visible" : "auto", padding: isMobile ? "24px 16px" : "32px" }}>
        ...
        {!loading && !result && (
          ...
          >
            ...
            <p style={{ fontSize: "15px", fontWeight: 500, letterSpacing: "-0.02em", textAlign: "center" }}>
        ...
        {!loading && result && (
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "560px", margin: "0 auto" }}>
            ...
            >
              <p style={{ fontSize: "15px", fontWeight: 600, color: "#727272", letterSpacing: "-0.02em", alignSelf: "flex-start" }}>
                ATS Score
              </p>
              <ArcGauge score={result.score} />
              <p style={{ fontSize: "15px", color: "#C3C3C3", fontWeight: 500 }}>
            ...
            >
              <p style={{ fontSize: "15px", fontWeight: 600, color: "#727272", letterSpacing: "-0.02em", marginBottom: "16px" }}>
                Keyword Analysis
              </p>
              <KeywordPills
            ...
            {result.action_words && (
              ...
              >
                ...
                {result.action_words.weak.length === 0 && (
                  <p style={{ fontSize: "15px", color: "#01B747", fontWeight: 500 }}>
